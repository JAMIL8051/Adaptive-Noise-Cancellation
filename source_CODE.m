...
[desired,Fs] = audioread('2.m4a');% Loading of test signal. You can change the name of the file and load another test signal.
...
soundsc(E,Fs)%Playing the output file
